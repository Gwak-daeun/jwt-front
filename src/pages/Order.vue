        ...
        <div class="needs-validation" novalidate>
          ...
          <div class="my-3">
            <div class="form-check">
              <input id="card" value="card" name="paymentMethod" type="radio" class="form-check-input" checked  v-model="state.form.payment">
              <label class="form-check-label" for="card">신용카드</label>
            </div>
            <div class="form-check">
              <input id="bank" value="bank" name="paymentMethod" type="radio" class="form-check-input"  v-model="state.form.payment">
          ...
          <div class="row gy-3">
              ...
              <input type="text" class="form-control" id="cc-name" req v-model="state.form.cardNumber">         
